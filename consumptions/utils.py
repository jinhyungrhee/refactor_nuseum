...
def nutrient_calculator(day_food_data, day_supplement_data, day_water_data, reporting_date):
  ...
  water = 0
  # method1 : dict
  category_mapper = {'채소':1, '샐러드':1, '나물':1, '과일':2, '과실':2, '두부':3, '콩/두부':3, '두류':3, '두유':3, '메주':3, '된장':3, '통곡물':4, '버섯':5, '해조류':6, '견과':7, '고기/생선/달걀':8, '육류':8, '난류':8, '수산물':8, '어패류':8, '회류':8, '우유':9, '치즈':9, '유제품':9, '발효유':9, '가공유':9, '가공두유':9 }
